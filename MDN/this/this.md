...
In most cases, the value of `this` is determined by how a function is called (runtime binding). It can't be set by assignment during execution, and it may be different each time the function is called. ES5 introduced the [`bind()`](../global_objects/function/bind) method to [set the value of a function's `this` regardless of how it's called](this#The_bind_method), and ES2015 introduced [arrow functions](../functions/arrow_functions) which don't provide their own `this` binding (it retains the `this` value of the enclosing lexical context).

## [](#try_it)Try it

[MDN Web Docs Interactive Example](https://interactive-examples.mdn.mozilla.net/pages/js/expressions-this.html)
...
### [](#derived_classes)Derived classes
...
### [](#this_in_function_contexts)this in function contexts
...
### [](#this_and_object_conversion)this and object conversion
...
### [](#the_bind_method)The `bind` method
...
### [](#as_an_object_method)As an object method
...
#### [](#this_on_the_objects_prototype_chain)`this` on the object's prototype chain
...
#### [](#this_with_a_getter_or_setter)`this` with a getter or setter
...
### [](#as_a_constructor)As a constructor
...
### [](#as_a_dom_event_handler)As a DOM event handler
...
### [](#in_an_inline_event_handler)In an inline event handler
...
### [](#this_in_classes)this in classes
...
| `this` | 1       | 12     | 1       | 4                 | 9.5   | 1      | 1               | 18             | 4                   | 10.1          | 1             | 1.0              | 1.0  | 0.10.0  |
...
- [Edit on **GitHub**](https://github.com/mdn/content/edit/main/files/en-us/web/javascript/reference/operators/this/index.md)
- [Source on **GitHub**](https://github.com/mdn/content/blob/main/files/en-us/web/javascript/reference/operators/this/index.md?plain=1)
- [Report a problem with this content on **GitHub**](https://github.com/mdn/content/issues/new?template=page-report.yml&mdn-url=https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FJavaScript%2FReference%2FOperators%2Fthis&metadata=%3C%21--+Do+not+make+changes+below+this+line+--%3E%0A%3Cdetails%3E%0A%3Csummary%3EPage+report+details%3C%2Fsummary%3E%0A%0A*+Folder%3A+%60en-us%2Fweb%2Fjavascript%2Freference%2Foperators%2Fthis%60%0A*+MDN+URL%3A+https%3A%2F%2Fdeveloper.mozilla.org%2Fen-US%2Fdocs%2FWeb%2FJavaScript%2FReference%2FOperators%2Fthis%0A*+GitHub+URL%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fblob%2Fmain%2Ffiles%2Fen-us%2Fweb%2Fjavascript%2Freference%2Foperators%2Fthis%2Findex.md%0A*+Last+commit%3A+https%3A%2F%2Fgithub.com%2Fmdn%2Fcontent%2Fcommit%2F4e55ef8d3618f047997d8670fce06b838de6a17b%0A*+Document+last+modified%3A+2022-03-25T23%3A14%3A02.000Z%0A%0A%3C%2Fdetails%3E)
- Want to fix the problem yourself? See [our Contribution guide](https://github.com/mdn/content/blob/main/README.md).

**Last modified:** Mar 25, 2022, [by MDN contributors](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/this/contributors.txt)
